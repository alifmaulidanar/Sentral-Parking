...
<head>
    ...
    <link rel="stylesheet" href="css/rekap_data.css">
                ...
                <li class="nav-item w-50">
                    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                        <div class="navbar-nav justify-content-around">
                            <a class="nav-item nav-link menu" href="home.php?username=<?= $username ?>">Home</a>
                            ...
                            <!-- <a class="nav-item nav-link menu active" href="rekap-data.php?username=<?= $username ?>&tanggal=<?= $tgl_hr_ini ?>">Rekap Data</a> -->
                        </div>
                    </div>
                </li>
            </ul>
            ...
            <div class="row w-100 marpad-1 justify-content-between mx-auto">
                ...
                <!-- <div class="col-lg-4">
                    <div class="row justify-content-end">
                        <a href="download.php?username=<?= $username ?>&tanggal=<?= $_SESSION['tanggal_terpilih'] ?>"><button type="submit" class="btn btn-primary tombol-submit">Download</button></a>
                    </div>
                </div> -->
            </div>
