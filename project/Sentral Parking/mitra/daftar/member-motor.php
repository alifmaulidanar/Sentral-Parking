...
<head>
    ...
    <link rel="stylesheet" href="css/member-motor.css">
                        ...
                        <div class="card masuk">
                            <div class="card-header">
                                <ul class="list-inline w-100 h-100 d-flex justify-content-start baris-judul-masuk">
                                    <li class="list-inline-item judul d-flex align-items-center">Pendaftaran Kartu (Member – Motor)</li>
                                </ul>
                            </div>
                                                ...
                                                if (isset($_POST['submit_button'])) {
                                                    ...
                                                    if ($row['kode_kartu'] == $kode) {
                                                        ...
                                                        if ($kartu['kode_kartu'] == $kode && $kartu['id_kode_kartu'] == $id_kode_kartu) {
                                                            $query = mysqli_query($con, "INSERT INTO kartu_daftar (id_kode_kartu, id_status, id_jenis) VALUES ('$id_kode_kartu', '2', '2')");
                                                        }
                        ...
                        <div class="card keluar">
                            <div class="card-header">
                                <ul class="list-inline w-100 h-100 d-flex justify-content-start baris-judul-keluar">
                                    <li class="list-inline-item judul d-flex align-items-center">Kartu (Member – Motor) Terdaftar</li>
                                </ul>
                            </div>
                            <div class="container form-kendaraan">
                                        ...
                                        <table class="table table-responsive-lg table-hover tabel-kendaraan">
                                            ...
                                            <tbody>
                                                <?php
                                                    ...
                                                    $query = mysqli_query($con, "SELECT kartu_daftar.id_kode_kartu, kartu_daftar.id_jenis, kartu_daftar.id_status, kartu_kartu.id_kode_kartu, kartu_kartu.kode_kartu FROM kartu_daftar, kartu_kartu WHERE kartu_daftar.id_status = '2' AND kartu_daftar.id_jenis = '2' AND kartu_daftar.id_kode_kartu = kartu_kartu.id_kode_kartu");
