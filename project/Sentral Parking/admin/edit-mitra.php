...
<head>
    ...
    <link rel="stylesheet" href="css/edit_mitra.css">
    ...
    <?php
        ...
        if (isset($_POST['submit_button'])) {
            ...
            if ($row['username'] == $uname) {
                echo "<script>alert('Username telah digunakan, silakan gunakan username lain.')</script>;document.location.href='mitra-kelola.php?username=$username";
            } else {
                ...
                if ($password == $confirm_password) {
                    ...
                    $query = mysqli_query($con, "UPDATE data_mitra SET username = '$uname', password = '$hash_confirmed' WHERE id_mitra = '$_GET[id_mitra]' AND deleted = '0'");
                    echo "<script>alert('Data mitra $uname berhasil diperbarui.');document.location.href='mitra-kelola.php?username=$username'</script>";
                } else {
                    echo "<script>alert('Masukkan ulang password dengan benar!');document.location.href='edit-mitra.php?username=$username&id_mitra=$_GET[id_mitra]'</script>";
                }
            }
        }
                        ...
                        <div class="card masuk">
                            <div class="card-header">
                                <ul class="list-inline w-100 h-100 d-flex justify-content-start baris-judul-masuk">
                                    <li class="list-inline-item judul d-flex align-items-center">Edit Mitra</li>
                                </ul>
                            </div>
                            <div class="container form-kendaraan">
                                ...
                                <form action="" method="post">
                                    ...
                                    <div class="row justify-content-end">
                                        <a href="mitra-kelola.php?username=<?= $username ?>" type="button" class="btn btn-danger tombol-hapus align-middle">Cancel</a>
