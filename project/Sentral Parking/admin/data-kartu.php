                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <!-- <h6 class="dropdown-header">Pilih Status Kartu</h6> -->
                                            <a class="dropdown-item active" href="data-kartu.php?username=<?= $username ?>">Semua</a>
                                            <div class="dropdown-divider"></div>
                                            <a class="dropdown-item" href="data-kartu/visitor-mobil.php?username=<?= $username ?>">Visitor – Mobil</a>
                                            <div class="dropdown-divider"></div>
                                            <a class="dropdown-item" href="data-kartu/visitor-motor.php?username=<?= $username ?>">Visitor – Motor</a>
                                            <div class="dropdown-divider"></div>
                                            <a class="dropdown-item" href="data-kartu/member-mobil.php?username=<?= $username ?>">Member – Mobil</a>
                                            <div class="dropdown-divider"></div>
                                            <a class="dropdown-item" href="data-kartu/member-motor.php?username=<?= $username ?>">Member – Motor</a>
                                            <div class="dropdown-divider"></div>
                                            <a class="dropdown-item" href="data-kartu/guest.php?username=<?= $username ?>">Guest</a>
                                            <div class="dropdown-divider"></div>
                                            <a class="dropdown-item" href="data-kartu/vip.php?username=<?= $username ?>">VIP</a>
                                        </div>
                                    </td>
                                </tr>
                                <!-- <tr>
                        ...
                        <div class="card riwayat">
                            <div class="card-header">
                                <ul class="list-inline w-100 h-100 d-flex justify-content-between baris-judul-keluar">
                                    <li class="list-inline-item judul d-flex align-items-center">Data Kartu (Semua)</li>
                                        ...
                                        if($query->num_rows > 0){
                                            while($row = $query-> fetch_assoc()){
                                                ...
                                                echo "<tr>
                                                    ...
                                                    <td>$row[status]</td>
                                                    <td>$row[jenis]</td>
                                                    <td><a onClick=\"javascript: return confirm('Apakah yakin ingin menghapus kartu dengan kode '$row[kode_kartu]' ini?');\" style='color: #C03738;' id='hapus' href='kartu-hapus.php?username=$username&id_kode_kartu=$id_kode_kartu'>Hapus</a></td>
                                                </tr>";
                                            }
                                        } else {
