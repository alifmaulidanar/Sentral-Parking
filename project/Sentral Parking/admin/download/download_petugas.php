<?php
    ...
    header("Content-Disposition: attachment; filename=Aktivitas_Petugas_" . $bulan_datepicker_judul . "_(" . $waktu_download . "_" . $tanggal_hari_ini . ").xls");
                ...
                <div class='card riwayat mb-lg-5'>
                    <div class='card-header'>
                        <ul class='list-inline w-100 h-100 d-flex justify-content-start'>
                            <li class='list-inline-item judul d-flex align-items-center'>Aktivitas Log In Petugas (" . $bulan_datepicker_excel . ") || (Waktu Download: " . $waktu_download_excel . " - " . $tanggal_hari_ini_excel . ")</li>
                        </ul>
                    </div>
