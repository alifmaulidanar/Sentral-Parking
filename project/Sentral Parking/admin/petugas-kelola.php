...
<head>
    ...
    <link rel="stylesheet" href="css/petugas_kelola.css">
...
<body>
    <?php 
        ...
        if (isset($_POST['submit_button'])) {
            $uname = $_POST['username_petugas_baru'];
            ...
            if ($row['username'] == $uname) {
                ...
                if ($password == $confirm_password) {
                    ...
                    $query = mysqli_query($con, "INSERT INTO data_petugas (username, password) VALUES ('$uname', '$hash_confirmed')");
                    echo "<script>alert('Petugas baru berhasil didaftarkan.');document.location.href='petugas-kelola.php?username=$username'</script>";
                } else {
                    echo "<script>alert('Masukkan ulang password dengan benar!');document.location.href='petugas-kelola.php?username=$username'</script>";
                }
            }
        }
        ...
        <nav class="navbar navbar-expand-lg navbar-dark d-flex gradien fixed-top w-100 align-middle">
            ...
            <ul class="navbar-nav profile d-flex align-items-center justify-content-end">
                <li class="nav-item dropdown active text-right">
                    ...
                    <div class="dropdown-menu logout dropdown-menu-right" aria-labelledby="navbarDropdown" href="?logout">
                        ...
                        <div class="card masuk">
                            <div class="card-header">
                                <ul class="list-inline w-100 h-100 d-flex justify-content-start baris-judul-masuk">
                                    <li class="list-inline-item judul d-flex align-items-center">Form Petugas Baru</li>
                                </ul>
                            </div>
                                        ...
                                        <div class="col-lg-11 w-100 identitas">
                                            <div class="row">
                                                <div class="col form-group">
                                                    <input type="text" class="form-control plat" name="username_petugas_baru" id="username" placeholder="Username" required>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col form-group">
                                                    <input type="password" class="form-control merek" name="password_petugas_baru" id="validate_password" placeholder="Password" minlength="8" required>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col form-group">
                                                    <input type="password" class="form-control merek" name="confirm_password_petugas_baru" id="validate_confirm_password" placeholder="Konfirmasi Password" minlength="8" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <?php
                                                    ...
                                                    if($query->num_rows > 0){
                                                        while($row = $query-> fetch_assoc()){
                                                            ...
                                                            // $_SESSION['id_petugas'] = hash('crc32b', $id_petugas);
                                                            // $hash = hash('sha256', '24');
                                                            echo "<tr>
                                                                <td>$row[username]</td>
                                                                <td><a style='color: #C03738;' href='edit-petugas.php?username=$username&id_petugas=$id_petugas'>Edit</a> | <a onClick=\"javascript: return confirm('Apakah yakin ingin menghapus Petugas ini?');\" style='color: #C03738;' id='hapus' href='petugas-hapus.php?username=$username&id_petugas=$id_petugas'>Hapus</a></td>
                                                            </tr>";
                                                        }
                                                    } else {
