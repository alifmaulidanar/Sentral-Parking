...
<head>
    ...
    <link rel="stylesheet" href="css/rekap_data_admin.css">
            ...
            <div class="row w-100 marpad-1 justify-content-between mx-auto">
                ...
                <div class="col-lg-4">
                    <div class="row justify-content-end">
                        <div class="dropdown">
                        <button class="btn btn-primary tombol-submit dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            Download
                        </button>
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item" href="../download.php?username=<?= $username ?>&tanggal=<?= $_SESSION['tanggal_terpilih'] ?>">Rekap Harian</a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="../download_bulan.php?username=<?= $username ?>&bulan=<?= $_SESSION['bulan_terpilih'] ?>">Rekap Bulanan</a>
                        </div>
                    </div>
                    </div>
                </div>
