...
<head>
    ...
    <title>Data Kartu - Visitor – Mobil</title>
</head>
<body>
    <?php
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            ...
                                            <div class="dropdown-divider"></div>
                                            <a class="dropdown-item active" href="visitor-mobil.php?username=<?= $username ?>">Visitor – Mobil</a>
                                            <div class="dropdown-divider"></div>
                        ...
                        <div class="card riwayat">
                            <div class="card-header">
                                <ul class="list-inline w-100 h-100 d-flex justify-content-between baris-judul-keluar">
                                    <li class="list-inline-item judul d-flex align-items-center">Data Kartu (Visitor – Mobil)</li>
                                    <li class="list-inline-item kosong d-flex align-items-center">
                                        Total Kartu:
                                        <?php
                                            include '../../config/koneksi2.php';
                                            $query = mysqli_query($con, "SELECT COUNT(*) FROM kartu_daftar WHERE id_status = '1' AND id_jenis = '1'");
