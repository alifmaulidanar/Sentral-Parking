                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            ...
                                            <div class="dropdown-divider"></div>
                                            <a class="dropdown-item active" href="guest.php?username=<?= $username ?>">Guest</a>
                                            <div class="dropdown-divider"></div>
                        ...
                        <div class="card riwayat">
                            <div class="card-header">
                                <ul class="list-inline w-100 h-100 d-flex justify-content-between baris-judul-keluar">
                                    <li class="list-inline-item judul d-flex align-items-center">Data Kartu (Guest)</li>
                                    <li class="list-inline-item kosong d-flex align-items-center">
                                        Total Kartu:
                                        <?php
                                            include '../../config/koneksi2.php';
                                            $query = mysqli_query($con, "SELECT COUNT(*) FROM kartu_daftar WHERE id_status = '3' AND id_jenis = '3'");
