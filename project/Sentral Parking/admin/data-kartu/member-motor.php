...
<head>
    ...
    <title>Data Kartu - Member – Motor</title>
</head>
<body>
    <?php
                ...
                <li class="nav-item w-100">
                    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                        <div class="navbar-nav justify-content-around menu-lists">
                            ...
                            <a class="nav-item nav-link menu" href="../rekap-data?username=<?= $username ?>">Rekap Data</a>
                        </div>
                    </div>
                </li>
            </ul>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            ...
                                            <div class="dropdown-divider"></div>
                                            <a class="dropdown-item" href="member-mobil.php?username=<?= $username ?>">Member – Mobil</a>
                                            <div class="dropdown-divider"></div>
                                            <a class="dropdown-item active" href="member-motor.php?username=<?= $username ?>">Member – Motor</a>
                                            <div class="dropdown-divider"></div>
                        ...
                        <div class="card riwayat">
                            <div class="card-header">
                                <ul class="list-inline w-100 h-100 d-flex justify-content-between baris-judul-keluar">
                                    <li class="list-inline-item judul d-flex align-items-center">Data Kartu (Member – Motor)</li>
                                    <li class="list-inline-item kosong d-flex align-items-center">
                                        Total Kartu:
                                        <?php
                                            include '../../config/koneksi2.php';
                                            $query = mysqli_query($con, "SELECT COUNT(*) FROM kartu_daftar WHERE id_status = '2' AND id_jenis = '2'");
