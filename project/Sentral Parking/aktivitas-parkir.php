...
<head>
    ...
    <link rel="stylesheet" href="css/data_kendaraan.css">
...
<body>
    ...
    <div class="container-fluid w-100">
                ...
                <li class="nav-item w-50">
                    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                        <div class="navbar-nav justify-content-around">
                            <a class="nav-item nav-link menu" href="home.php?username=<?= $username ?>">Home<span class="sr-only">(current)</span></a>
        ...
        <div class="container-fluid">
            <div class="row w-100 marpad-1 justify-content-center mx-auto">
                <!-- Card Jumlah Mobil -->
                <div class="col-lg-4">
                        ...
                        <div class="card riwayat mb-lg-5">
                            <div class="card-header">
                                <ul class="list-inline w-100 h-100 d-flex justify-content-start">
                                    <li class="list-inline-item judul d-flex align-items-center">Riwayat Parkir Hari Ini</li>
                                </ul>
                            </div>
