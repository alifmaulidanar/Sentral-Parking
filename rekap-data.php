                ...
                <li class="nav-item w-50">
                    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                        <div class="navbar-nav justify-content-around">
                            ...
                            <a class="nav-item nav-link menu" href="data-kendaraan.php?username=<?= $username ?>">Data Kendaraan</a>
            ...
            <div class="row w-100 marpad-1 justify-content-between mx-auto">
                ...
                <div class="col-lg-4">
                    <div class="row justify-content-end">
                        <a href="download.php"><button type="submit" class="btn btn-primary tombol-submit">Download</button></a>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card riwayat mb-lg-5">
                            <div class="card-header">
                                <ul class="list-inline w-100 h-100 d-flex justify-content-start">
                                    <li class="list-inline-item judul d-flex align-items-center">Riwayat Parkir
                                        <?php
